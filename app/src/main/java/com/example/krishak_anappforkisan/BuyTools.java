...
public class BuyTools extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_tools);
        ...
        button19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myRef1 = database1.getReference("sell-tools");
                myRef1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            for (DataSnapshot ds1 : ds.getChildren()) {
                                if(ds1.getKey().toString().equals("tool name")){
                        ...
                        mAdapter = new RecyclerViewAdapter(itemList, BuyTools.this);
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(BuyTools.this);
                    ...
                    public void onCancelled(DatabaseError error) {
                        ...
                        Toast.makeText(BuyTools.this, "error", Toast.LENGTH_LONG).show();
