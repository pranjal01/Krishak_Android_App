...
public class MerchentBuyNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_merchent_buy_new);
        ...
        button19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myRef1 = database1.getReference("at-your-price");
                myRef1.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mAdapter = new RecyclerViewAdapter(itemList, MerchentBuyNew.this);
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(MerchentBuyNew.this);
                    ...
                    public void onCancelled(DatabaseError error) {
                        ...
                        Toast.makeText(MerchentBuyNew.this, "error", Toast.LENGTH_LONG).show();
